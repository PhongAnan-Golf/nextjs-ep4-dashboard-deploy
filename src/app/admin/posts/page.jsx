                  ...
                  <tbody>
                    {allPostsData?.map((val) => (
                      <tr key={val._id}>
                        ...
                        <td className='p-5'>
                          <Image src={val.img} width={80} height={80} alt={val._id} />
                        </td>
                        <td className='p-5'>{val.content}</td>
                        <td className='p-5'>
                          <Link className='bg-gray-500 text-white border py-2 px-3 rounded texy-ls my-2' href={`/admin/posts/edit/${val._id}`}>
                            Edit
                          </Link>
